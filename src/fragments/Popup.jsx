...
const PopUp = () => {
  return (
    <div className='absolute translate-x-4 md:translate-x-1/2 -translate-y-60 w-11/12 md:w-1/2 overflow-hidden z-20 rounded-tl-sm md:rounded-tl-2xl rounded-tr-sm md:rounded-tr-2xl font-lato'>
      <div
        ...
        <div className='absolute top-2 right-2 md:top-5 md:right-5 flex items-center justify-center text-light-secondary text-lg rounded-full p-1 md:p-2 w-4 h-4 md:w-[30px] md:h-[30px] bg-pageHeaderBackground cursor-pointer z-50'>
          <img
        ...
        <div className='relative w-full z-50 flex flex-col gap-2 md:gap-6 px-5 py-2.5 md:px-0 md:py-0'>
          ...
          <div className='w-full flex justify-between z-30'>
            <div className='flex gap-2 md:gap-2.5'>
              ...
              <button className='w-6 md:w-11 h-6 md:h-11 border border-light-secondary rounded-full text-light-secondary text-sm md:text-2xl font-bold cursor-pointer'>
                +
              </button>
            </div>
      ...
      <div className='bg-pageHeaderBackground text-light-primary px-5 py-2.5 md:px-16 md:py-6 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-2.5'>
        <div className='flex flex-col gap-1'>
          <div className='flex gap-4 items-center text-light-secondary font-normal'>
            ...
            <p className='text-xs md:text-base'>10 episode</p>
