...
const Footer = () => {
  return (
    <footer className='max-w-screen bottom-0 border-t border-bodyBackground bg-pageHeaderBackground h-48 md:h-[284px] p-5 md:px-20 md:py-[60px] font-lato text-white flex flex-col gap-10 md:grid md:grid-cols-3'>
      ...
      <div className='flex flex-col gap-2 md:col-start-2 md:col-end-4 md:grid md:grid-cols-4'>
        ...
        <div className='col-start-4 col-end-5 flex flex-col gap-[15px]'>
          <div className='flex justify-between items-center'>
            <h4 className='font-bold tracking-[.2px] cursor-default'>
              Bantuan
            </h4>
            <div className='md:hidden'>
              <MdKeyboardArrowRight className='text-2xl' />
